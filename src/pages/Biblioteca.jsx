...
const Biblioteca = () => {
  ...
  const grupoFiltrado = filtroGrupo
    ...
    : gruposMusculares;
  const exerciciosFiltradosPorGrupo = Object.entries(grupoFiltrado)
    ...
    <PageWrapper>
      ...
      >
        <div className="p-4 max-w-screen-lg mx-auto space-y-8">
          ...
          <div
            className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 animate-slideInFromLeft"
            ...
            <div className="flex items-center mb-3 sm:mb-0">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400 mt-1">
                  Explore exercícios e visualize seu progresso.
                </p>
              </div>
            </div>
          </div>
          ...
          <div
            className="bg-slate-800 rounded-xl shadow-lg overflow-hidden animate-slideInFromRight"
            ...
            <div className="p-4">
                ...
                <button
                  ...
                  className={`flex items-center text-sm ${
                    activeFilters
                      ...
                      : "text-gray-400"
                  } hover:text-blue-300 transition-colors duration-200 group`}
                >
                  <Filter
                    size={16}
                    className="mr-1.5 group-hover:animate-spinOnce"
                  />
                  Filtrar por Grupo
                  <ChevronDown
                    size={16}
              ...
              <div
                className={`transition-all duration-300 ease-out overflow-hidden ${
                  activeFilters ? "max-h-40 mt-4" : "max-h-0 mt-0"
                }`}
              >
                {activeFilters && (
          ...
          <div className="space-y-8">
            {exerciciosFiltradosPorGrupo.length > 0 ? (
              exerciciosFiltradosPorGrupo.map(
                ({ grupo, exercicios }, grupoIndex) => (
                  <div
                    key={grupo}
                  ...
                  >
                    <div className="flex items-center mb-4 pl-1">
                      <div
                        ...
                        style={{
                          background: `linear-gradient(to bottom, ${getGrupoColor(
                            grupo
                          )}, ${getGrupoColor(grupo)}99)`,
                        }}
                      ></div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                      {exercicios.map((exercicio, exIndex) => (
                        <div
                          key={exercicio}
                          className={`bg-gradient-to-br from-slate-800 to-slate-800/70 rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-2xl hover:scale-[1.03] animate-fadeInUp border border-slate-700/50 relative group ${
                            hoveredExercise === exercicio
                              ? "ring-2 ring-offset-2 ring-offset-slate-900"
                              : ""
                          }`}
                          style={{
                            animationDelay: `${
                              exIndex * 50 + grupoIndex * 150
                            }ms`, // Atraso menor
                            borderColor:
                              hoveredExercise === exercicio
                                ? getGrupoColor(grupo)
                        ...
                        >
                          ...
                          <div
                            ...
                            style={{
                              background: `radial-gradient(circle at top left, ${getGrupoColor(
                                grupo
                              )}15, transparent 60%)`,
                            }}
                          ></div>
                          ...
                          <div className="p-4 relative z-10">
                              ...
                              <div className="relative group/image flex-shrink-0">
                                <img
                                  ...
                                  onError={(e) => {
                                    ...
                                    e.target.src =
                                      "https://via.placeholder.com/150?text=Sem+Img";
                                  }}
                                />
                            ...
                            <div className="flex justify-between items-center">
                              <span
                                ...
                                style={{
                                  background: `linear-gradient(to right, ${getGrupoColor(
                                    grupo
                                  )}30, ${getGrupoColor(grupo)}10)`,
                              ...
                              <button
                                className={`px-3 py-1.5 rounded-lg text-xs flex items-center transition-all duration-300 transform hover:scale-105 ${
                              ...
                              <div className="px-4 pb-4 border-t border-slate-700/50 mt-3 pt-4 animate-fadeIn">
                                ...
                                <div className="flex flex-wrap gap-2 mb-4">
                                  {[
                                    ...
                                    <button
                                      key={tipo.id}
                                      className={`px-3 py-1 rounded-lg text-xs flex items-center transition-all duration-200 transform hover:scale-105 ${
                                        tipoGrafico === tipo.id
                                ...
                                {isGraphLoading ? (
                                  <div className="bg-slate-700/40 rounded-lg p-6 mb-2 flex flex-col items-center justify-center text-center shadow-inner border border-slate-600/30 h-56">
                                    <RotateCw
                                      size={28}
                                      className="text-blue-400 mb-3 animate-spin"
                                    />
              ...
              <div className="bg-slate-800 rounded-xl p-10 flex flex-col items-center justify-center text-center animate-fadeInUp mt-8 shadow-lg border border-slate-700/50">
                ...
                <p className="text-gray-400 text-sm max-w-xs">
                  Parece que sua busca não retornou resultados. Tente ajustar os
                  filtros ou o termo de busca.
                </p>
                {(filtroGrupo || buscaExercicio) && (
                  ...
                  >
                    <XIcon size={16} className="mr-1.5" /> Limpar Busca e
                    Filtros
                  </button>
                )}
              </div>
        ...
        {/* Modal de Imagem com Lógica Funcional (do pasted_content_2.txt) e Botão X - TAMANHO AJUSTADO */}
        {imagemModal && (
          <div
          ...
          >
            {/* Container da imagem posicionado com base na viewport - TAMANHO AJUSTADO */}
            <div
              ...
              style={{
                ...
                maxWidth: "90vw", // Aumentado de 90vw para 95vw
                maxHeight: "80vh", // Aumentado de 80vh para 90vh
                width: "auto", // Permite que a largura se ajuste ao conteúdo
                height: "65vh", // Permite que a altura se ajuste ao conteúdo
              }}
            ...
            >
              <img
                ...
                style={{ maxHeight: "inherit", maxWidth: "inherit" }} // Garante que a imagem respeite os limites do container
                onError={(e) => {
                  e.target.onerror = null;
                  e.target.src =
                    "https://via.placeholder.com/800x600?text=Imagem+Indispon%C3%ADvel"; // Placeholder maior
                }}
              />
